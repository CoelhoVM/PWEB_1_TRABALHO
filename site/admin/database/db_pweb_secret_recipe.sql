...
INSERT INTO `receitas` (`id`, `titulo`, `modo_preparo`, `tempo_preparo`, `dificuldade`, `id_usuario`) VALUES
	(1, 'Lasanha', 'Dirija-se até o mercado. Procure a sessão onde se encontram as lasanhas. Pegue uma. Passe no caixa (opcional). ', '46min', 'Difícil', 1);
...
INSERT INTO `usuarios` (`id`, `username`, `nome`, `email`, `telefone`, `senha`) VALUES
	(1, 'CoelhoVm', 'Vitórya Miranda Coelho', 'vitoryamcoelho@gmail.com', '(49) 98920-0392', '$2y$10$gAhdGmSzTd4iJjrA2q.Htug1lqf/m/WdfeiafADqfxON3A77ozXOK'),
	(2, 'MadriFG', 'Flavia Regina Madri', 'Flavia@gmail.com', '(49) 98922-4002', '$2y$10$DKdUA4Q9AA1d5Kt/m40if.pArfK.IborSy1ad.Q7NyN8jOjaoyqLS'),
	(3, 'Orelha', 'Angelo L.', 'Angelo@gmail.com', '(49) 98922-4002', '$2y$10$DLR9pQWxeP.IiAbrK7o9FuedCfCUdEtYZEeCD2d.TQ39HYLrSPZa.');
